...
#define OROPKG_SUPPORT_XERCES_C
...
#define ORODAT_CORELIB_PROPERTIES_DEMARSHALLING_INCLUDE "marsh/CPFDemarshaller.hpp"
#define OROCLS_CORELIB_PROPERTIES_DEMARSHALLING_DRIVER CPFDemarshaller
#endif
